export const tcxData = {
  ...
  export function readGeneralPart(jsonData): any {
  ...
  export function readTrackPoints(trackPoints) {
  ...
  export function readAuthorData(trainingCenter) {
